...
// +kubebuilder:rbac:groups=webhook.image-relocation.pivotal.io,resources=imagemaps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=webhook.image-relocation.pivotal.io,resources=imagemaps/status,verbs=get;update;patch
